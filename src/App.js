...
export default function App() {
  return (
    <div className="App grid">
      <header>
        <h1 className="highlighted-text">Ken Spry</h1>
      ...
      <div className="main main-text">
        <div className="stacked">
          <div>
            ...
            <p>
              ...
              interaction for logging and viewing information that allowed users
              to complete tasks faster and more effectively than with other
              systems.
            </p>
            <p>
              ...
              that mirrored what users would see in the final application. Using
              Framer, we were able to plug these components into various
              prototypes with simple drag-and-drop functionality. Our prototypes
              and documented components reduced guesswork and boomerangs between
              design and development, saved us time prototyping, and ensured
              that we were investing our time in the places it mattered most.
            </p>
          </div>
        </div>
        <div className="stacked">
          <h4>
            ...
            unexpected, test realistically, and hand off quality design. That’s
            why I’m dedicated to teaching this skill to the next generation of
            designers.
          </h4>
          <figure>
            <div>
        ...
        <div className="section col">
          ...
          <div>
            <p>
              ...
              were experiencing numerous usability problems as they moved from a
              ...
              destroying the meaning created by the layout on the canvas. My
        ...
        <div className="section col">
          ...
          <div>
            <p>
              For this project, completed in 2016, we wanted to give health care
              providers a way to discover points of interest right away for
              their patients, then allow them to dig deeper using search or by
              selecting rows or columns of data points to cluster in the detail
              view. I used D3 for this project. My partners wired it up using
              available deidentified patient data for the FHIR-athon at Eskenazi
              Health.
            </p>
          </div>
        </div>
